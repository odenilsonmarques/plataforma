  ...
  <body>
    ...
    <section class="anime">
      <div class="container-fluid" id="departamento">    
        <div class="container"> 
        <h2 class="text-left text-success"><b>Departamento</b></h2>
          <div class="row">
            <div class="col-sm-4 text-center text-success">
              <h3 class="text-success"><b>Sobre</b></h2>
            ...
            <div class="col-sm-4 text-center">
              <h3 class="text-success"><b>Missão</b></h2>
                <p class="text-success">
            ...
            <div class="col-sm-4 text-center">
              <h3 class="text-success"><b>Visão</b></h2>
                <p class="text-success">
          ...
          <div class="row">
            ...
            <div class="col-lg-4 text-center">
              <img src="{{('/assets/img/missao.png')}}" style="text-align:center; color:#77cc6d">
            </div>
            <div class="col-lg-4 text-center text-success">
              ...
              <div id="myCarouselAracagy" class="carousel slide" data-ride="carousel" >
                <!-- Indicators -->
                  <ol class="carousel-indicators">
                    ...
                    <li data-target="#myCarouselAracagy" data-slide-to="2"></li>
                    <li data-target="#myCarouselAracagy" data-slide-to="3"></li>
                  </ol>
                    <!-- Wrapper for slides -->
                  <div class="carousel-inner">
                    <div class="item active">
                    ...
                    <div class="item">
                      <div class="col-lg-12">                                       
                        <img src="{{('/assets/img/img149.jpg')}}" alt="Lights" class="img-responsive" style="height: 500px">
                      </div>      
                    </div>
                    <div class="item">
                      <div class="col-lg-12">                                       
      ...
      <div class="modal fade" id="myModalPraiaUnicamping" role="dialog">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header"><br/><br/>
              <button type="button" class="close" data-dismiss="modal">&times;</button>
              <h4 class="modal-title text-center">Porto Unicamping</h4>
            </div>
            <div class="modal-body">
              <!--inicio carrossel-->
              <div id="myCarouselUnicamping" class="carousel slide" data-ride="carousel" >
                <!-- Indicators -->
                  <ol class="carousel-indicators">
                    ...
                    <li data-target="#myCarouselUnicamping" data-slide-to="2"></li>
                    <li data-target="#myCarouselUnicamping" data-slide-to="3"></li>
                  </ol>
                    <!-- Wrapper for slides -->
                  <div class="carousel-inner">
                    <div class="item active">
                    ...
                    <div class="item">
                      <div class="col-lg-12">                                       
                        <img src="{{('/assets/img/img136.jpg')}}" alt="Lights" class="img-responsive" style="height: 500px">
                      </div>      
                    </div>
                    <div class="item">
                      <div class="col-lg-12">                                       
                        <img src="{{('/assets/img/img137.jpg')}}" alt="Lights" class="img-responsive" style="height: 500px">
                      </div>      
                    </div>
                    <div class="item">
                      <div class="col-lg-12">                                       
              ...
              <div id="myCarouselMadalena" class="carousel slide" data-ride="carousel" >
                <!-- Indicators -->
                  <ol class="carousel-indicators">
                    ...
                    <li data-target="#myCarouselMadalena" data-slide-to="2"></li>
                    <li data-target="#myCarouselMadalena" data-slide-to="3"></li>
                  </ol>
                    <!-- Wrapper for slides -->
                  <div class="carousel-inner">
                    <div class="item active">
                    ...
                    <div class="item">
                      <div class="col-lg-12">                                       
                        <img src="{{('/assets/img/img142.jpg')}}" alt="Lights" class="img-responsive" style="height: 500px">
                      </div>      
                    </div>
                  </div>
                  <!-- Left and right controls -->
              ...
              <div id="myCarouselBanho" class="carousel slide" data-ride="carousel" >
                <!-- Indicators -->
                  <ol class="carousel-indicators">
                    ...
                    <li data-target="#myCarouselBanho" data-slide-to="2"></li>
                    <li data-target="#myCarouselBanho" data-slide-to="3"></li>
                  </ol>
                    <!-- Wrapper for slides -->
                  <div class="carousel-inner">
                    <div class="item active">
                    ...
                    <div class="item">
                      <div class="col-lg-12">                                       
                        <img src="{{('/assets/img/img145.jpg')}}" alt="Lights" class="img-responsive" style="height: 500px">
                      </div>      
                    </div>
                    <div class="item">
                      <div class="col-lg-12">                                       
                        <img src="{{('/assets/img/img146.JPG')}}" alt="Lights" class="img-responsive" style="height: 500px">
                      </div>      
                    </div>
                  </div>
                  <!-- Left and right controls -->
          ...
          <div class="row">
            ...
            <div class="tab-content">
              <div id="camboas" class="tab-pane fade in active">
                <h3 id="textoCuriosidade">Camboas de São José de Ribamar</h3>
                <p id="textoCuriosidade">Estão localizadas na praia da Ponta Verde, que são currais construídos de pedras para captura de peixes. Essas camboas foram feitas pelos índios gamelas que habitaram em São José de Ribamar no século XVII..</p>
                <div class="row">
                  <div class="col-lg-3">
              ...
              <div id="falesias" class="tab-pane fade">
                <h3 id="textoCuriosidade">falésias</h3>
                <p id="textoCuriosidade">As falésias são formações litorâneas que é produzida por processos erosivos naturais, relacionado a oscilações do nível do mar e mudanças nas condições climáticas. A praia da ponta verde é formada por paredões esculpidos pela ação da água do mar e do vento formando as falésias com belezas magnificas.</p>
                <div class="row">
                  <div class="col-lg-3">
              ...
              <div id="corredorDeAves" class="tab-pane fade">
                <h3 id="textoCuriosidade">Corredor das aves migratórias</h3>
                <p id="textoCuriosidade">O corredor de aves migratórias localiza-se na Praia da Ponta da Madalena situada no final da Praia do Panaquatira, as aves migratórias que durante um determinado período do ano migram para o Brasil, vindo de outros países como dos Estados Unidos, Canadá e Alasca, durante a viagem ao Brasil as aves encostam na  Praia da Ponta da Madalena para alimentação, descanso e reprodução. E em um determinado período elas seguem viagem para outras regiões do Maranhão e depois retornam para seu país de origem. </p>
              </div>
              <div id="ninhalCampina" class="tab-pane fade">
                <h3 id="textoCuriosidade">Ninhal da Campina</h3>
                <p id="textoCuriosidade">O ninhal encontra-se no manguezal no bairro da Campina no Município de São José de Ribamar. Os guarás utilizam o manguezal mais isolado para fazer os ninhos e aproveitam os galhos mais altos para escaparem da ação dos predadores. A reprodução dos guarás ocorre em colônias e vai de julho a setembro, durante os outros meses os ninhais permanecem vazios no período do dia, após o pôr do sol, os guarás retornam aos ninhais para dormirem e encherem de cores o manguezal. </p>
              </div>
              <div id="sitioArqueologico" class="tab-pane fade">
                <h3 id="textoCuriosidade">Sítio Arqueológico</h3>
                <p id="textoCuriosidade">O sítio arqueológico é localizado no pólo turístico de Panaquatira. No local, existem vestígios de uma população denominada "Sambaqui", que habitou o lugar entre 5 mil e 8 mil anos atrás. O local está sendo estudado para a construção de um museu arqueológico na área para garantir a preservação do patrimônio histórico, que seria o primeiro do Brasil nessas condições. </p>
                <div class="row">
                  <div class="col-lg-3">
